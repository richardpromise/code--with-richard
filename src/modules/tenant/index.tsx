  ...
  return (
    <div className="p-[30px]">
      <table className=" w-[80%] mx-auto ">
        <thead className=" bg-cyan-900 border text-[whitesmoke]">
          <tr className=" border border-black">
            <th className="border-r border-black text-left p-[10px]">
              Tenants
            </th>
            <th className="border-r border-black text-left p-[10px]">
              Tenant Details
        ...
        <tbody>
          <tr className="border border-black">
            ...
            <td className="border-r border-black flex items-center gap-3  p-[10px]">
              <span
